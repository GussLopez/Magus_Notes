        ...
        <header className={`${isDarkMode ? 'bg-gray-900' : 'bg-white'} px-4 shadow`}>
            <div className="relative mx-auto flex max-w-screen-lg flex-col py-4 md:flex-row md:items-center md:justify-between">
                ...
                <button 
                    ...
                    className="absolute right-0 top-4 cursor-pointer md:hidden"
                ...
                <nav className={`${isMenuOpen ? 'block' : 'hidden'} md:block mt-4 md:mt-0`}>
                    <ul className="flex flex-col md:flex-row gap-4 md:items-center">
                        <li>
                            <Link to="/" className={`${isDarkMode ? 'text-gray-200' : 'text-gray-700'} hover:text-cyan-500 transition-colors block`}>
                                Home
                            </Link>
                        </li>
                        <li>
                            <Link to="/perfil" className={`${isDarkMode ? 'text-gray-200' : 'text-gray-700'} hover:text-cyan-500 transition-colors block`}>
                                Perfil
                            </Link>
                        </li>
                        <li>
